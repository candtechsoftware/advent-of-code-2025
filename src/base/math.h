...
static inline f32 fast_expf(f32 x) {
  ...
  u.i =
      (int)(12102203.0f * x + 1065353216.0f); // 12102203 = 1/ln(2) * (1 << 23)
  return u.f;
}
...
static inline u32 hash_u32(u32 x) { return x * KNUTH_GOLDEN_RATIO_32; }

static inline u64 hash_u64(u64 x) { return x * KNUTH_GOLDEN_RATIO_64; }
